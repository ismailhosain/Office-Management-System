...
<html>
    ...
    include 'conn.php';
        if(isset($_POST['submit'])){
            ...
            $insert="insert into regis (username, email, mobile, password, cpassword) values('$username','$email','$mobile','$pass','$cpass')";
 ...
 ?>
    ...
    <div class="form-wrap">
     <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <p>have an account?<br><a href="login.php">login</a></p>
